# Practice project to demonstrate how to handle files operations in Java and how handle exceptions.

## Note
- This project is for educational purposes only. It demonstrates basic file operations and exception handling in Java.
